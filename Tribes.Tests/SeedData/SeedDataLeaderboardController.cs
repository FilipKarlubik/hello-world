...
namespace Tribes.Tests.SeedData
{
    ...
    {
        public static void PopulateForLeaderboardControllerTest(ApplicationContext appContext, bool includeKingdoms)
        {
            ...
            if (includeKingdoms)
            {
                ...
                Army army1 = new Army() { Soldiers = new List<Soldier>(), Type = String.Empty };
                Army army2 = new Army() { Soldiers = new List<Soldier>(), Type = String.Empty };
                Army army3 = new Army() { Soldiers = new List<Soldier>(), Type = String.Empty };
